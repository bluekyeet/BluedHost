...
.loadingbar .bar {
  ...
  app.get(`/submitlogin`, async (req, res) => {
    ...
    let ip = (newsettings.api.client.oauth2.ip["trust x-forwarded-for"] == true ? (req.headers['cf-connecting-ip'] || req.headers['x-forwarded-for'] || req.connection.remoteAddress) : req.connection.remoteAddress);
    ...
    if (json.ok == true) {
      ...
      if (userinfo.verified == true) {
        ...
        if ((newsettings.api.client.oauth2.ip["duplicate check"] == true) && ip !== '127.0.0.1' && !newsettings.antivpn.whitelistedIPs.includes(ip)) {
